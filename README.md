...
- **路徑編輯功能**：點擊 "Edit" 按鈕可手動修改FW路徑，修改完成後點擊 "Confirmed" 確認更改
...
### 3. 路徑編輯功能
- **啟用編輯**：點擊 "Edit" 按鈕進入編輯模式
- **修改路徑**：在編輯模式下可手動修改固件路徑
- **確認變更**：修改完成後點擊 "Confirmed" 按鈕確認更改
- **自動同步**：確認後 SHA256 路徑會自動同步更新
- **狀態切換**：按鈕會在 "Edit" 和 "Confirmed" 之間切換，清楚顯示當前狀態
